...
#define LANDING_LIGHTS_AUTO_ALTITUDE 60
...
#define VBATNOMINAL     25.1 // 12,6V full battery nominal voltage - only used for lcd.telemetry
#define VBATLEVEL_WARN1 105 // (*) (**) 10,7V
#define VBATLEVEL_WARN2 99 // (*) (**) 9.9V
#define VBATLEVEL_CRIT  94 // (*) (**) 9.3V - critical condition: if vbat ever goes below this value, permanent alarm is triggered
...
//#define INFLIGHT_PID_TUNING_TYPE 3 // 0 for PITCH and ROLL
// 1 for PITCH
// 2 for ROLL
// 3 for PIDALT ALT
...
#define SONAR_GENERIC_SCALE 58.2				//scale for ranging conversion (hcsr04 is 58)
#define SONAR_GENERIC_MAX_RANGE 450			//cm (could be more)
